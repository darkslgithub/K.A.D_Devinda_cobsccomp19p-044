...
class SurveyViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let que3 = Question(imgName: "survey-img-3", questionText: "Have you been exposed with crowded places?", accept: false, isAnswered: false)
        let que4 = Question(imgName: "survey-img-4", questionText: "Have you been interact with any sick person recently?", accept: false, isAnswered: false)
